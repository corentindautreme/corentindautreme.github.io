      ...
      <div id="lys-more" class="snap-start w-full h-full flex flex-col gap-3 shrink-0 p-10 justify-center">
        ...
        <div class="flex flex-col md:flex-row md:items-between">
          <div class="grow flex flex-col gap-1">
            ...
            <div class="md:w-[33%] flex flex-col gap-1 mt-3">
            ...
            <div class="md:w-[33%] flex flex-col gap-1 mt-2">
              <div class="flex items-center gap-1 font-bold">
          ...
          <a class="md:max-w-40 mt-4 md:mt-0 flex flex-col items-end justify-center" href="#lys-intro">
            <div class="flex items-center gap-1 text-white/50">
