              ...
              <div class="relative w-full flex items-end justify-between">
                ...
                <div class="absolute left-1/2 -translate-x-1/2 w-[90%] h-full overflow-hidden">
                  <div class="relative size-full">
                    <svg viewBox="0 0 490 93" width="auto" height="50%" class="absolute bottom-0 flex items-end animate-tram-right" xmlns="http://www.w3.org/2000/svg">
  ...
  "routes": [
    ...
    <script>
      ...
      const jsonReplacer = function(match, pIndent, pKey, pVal, pEnd) {
        var key = '<span class="json-key text-neutral-500">',
