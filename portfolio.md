  ...
  <body class="bg-black text-white ">
    ...
    <div class="z-1 fixed top-0 left-0 w-full flex items-center justify-between p-2 backdrop-blur-sm border-b-1 border-white/30">
      ...
      <div class="flex items-center gap-1">
        ...
        <div class="rounded-full w-8 h-8 bg-gray-700"></div>
    ...
    <div id="esc-2021-logo-generator" class="bg-neutral-900 section snap-start w-full h-[100dvh] flex overflow-x-scroll snap-x snap-mandatory motion-reduce:scroll-auto scroll-smooth">
      ...
      <div id="esc-2021-logo-generator-css" class="relative snap-start w-full h-full flex flex-col gap-3 shrink-0 px-10 py-15 justify-center overflow-hidden">
        ...
        <div class="flex flex-col md:flex-row md:items-between h-full justify-center">
          ...
          <div class="grow flex flex-col gap-3 md:justify-center overflow-hidden">
            <div class="flex flex-col gap-3 md:items-end overflow-hidden">
            ...
            <a class="md:mt-5 flex flex-col items-end text-right" href="#esc-2021-logo-generator-coordinates">
      ...
      <div id="esc-2021-logo-generator-coordinates" class="relative snap-start w-full h-full flex flex-col md:flex-row-reverse gap-5 shrink-0 justify-center overflow-hidden">
        ...
        <div class="h-full px-10 pt-15 md:pt-0 grow flex flex-col gap-3 md:justify-center overflow-hidden">
          ...
          <a class="z-1 md:max-w-40 md:mt-5 flex flex-col" href="#esc-2021-logo-generator-more">
            <div class="flex items-center gap-1 text-white/50">
              Next
              <i data-lucide="arrow-right" class="w-5"></i>
            </div>
        ...
        <div class="relative flex flex-col gap-3 md:h-full justify-center md:aspect-1/1 px-5 md:pe-2">
          <div class="flex flex-col">
            <div class="flex items-center">
              ...
              <div class="flex flex-col items-center flex-1/7">
                <div class="hidden md:block">The Hague, NL</div>
          ...
          <div class="relative h-25 md:h-35 w-full flex items-center">
            ...
            <div class="absolute left-1.5 rounded-full w-[200%] aspect-1/1 top-[50%] translate-x-[-50%] translate-y-[-50%]">
              ...
              <!-- BE, NL, NO -->
              <div class="slice-2021 no-border border-b-2 border-dashed border-[#a0a0a0]" style="--color1: #ffc832; --color2: #ffc832; --color3: #ffc832; --color4: #ffc832; --color5: #fff; --color6: #fc0000; --color7: #fc0000; --offset:84.745455; --value: 5.554545"></div>
              <div class="slice-2021 before:border-t-2 before:border-dashed before:border-[#a0a0a0]" style="--color1: #fc0000; --color2: #fc0000; --color3: #fc0000; --color4: #fc0000; --color5: #fc0000; --color6: #0750c6; --color7: #0750c6; --offset:89.7; --value: 5.654545"></div>
              <!-- filler after -->
              ...
              <div class="absolute rounded-full w-[100%] aspect-1/1 overflow-hidden border-2 border-dashed border-[#a0a0a0]/30">
                <div class="absolute top-[14%] left-[14.5%] size-[71.2%] border-2 border-dashed border-[#a0a0a0]/30 rounded-full"></div>
