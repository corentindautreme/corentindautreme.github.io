...
<html class="overflow-y-scroll scroll-smooth motion-reduce:scroll-auto snap-y snap-mandatory">
  <head>
    ...
    <style type="text/tailwindcss">
      @theme {
        ...
        --animate-tram-right: tram-right 10s linear infinite;
        --animate-soft-bounce: soft-bounce 3s infinite;
  ...
  <body class="bg-black text-white ">
    ...
    <div id="transit-planner" class="tp-bg section snap-start w-full h-[100dvh] flex overflow-x-scroll snap-x snap-mandatory motion-reduce:scroll-auto scroll-smooth">
              ...
              <div class="relative w-full flex items-end justify-between">
                ...
                <div class="absolute left-1/2 -translate-x-1/2 w-[90%] h-full overflow-hidden">
                  <div class="relative size-full">
                    <div class="absolute bottom-0 flex items-end animate-soft-bounce h-full">
                      <svg viewBox="0 0 490 93" width="auto" height="50%" class="animate-tram-right" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="md:hidden w-full h-35 px-5 shrink-0 flex justify-center mt-1">
            <div class="relative w-full flex items-end justify-between overflow-hidden">
                ...
                <div class="absolute left-1/2 -translate-x-1/2 w-[90%] h-full overflow-hidden">
                  <div class="relative size-full">
                    <div class="absolute bottom-0 flex items-end animate-soft-bounce h-full">
                      <svg viewBox="0 0 490 93" width="auto" height="50%" class="animate-tram-right">
                        <!-- Tram body with rounded corners and sloped ends -->
                        <path d="M5,91 Q10,31 25,31 H468 Q478,31 481,91 Z" fill="gold" stroke="black" stroke-width="2" />
                ...
                <svg width="auto" height="60%" viewBox="0 0 140 278" class="z-1">
                  <!-- Steps -->
                  <g fill="#ddd">
                    <rect x="15" y="258" width="110" height="10" />
                    <rect x="10" y="268" width="120" height="10" />
                ...
                <svg width="auto" height="100%" viewBox="0 0 190 200" class="z-1">
                  <!-- Base building -->
                  <rect x="10" y="110" width="160" height="80" class="fill-[#cac3c3]" />
      ...
      <!-- lines -->
      <div id="transit-planner-lines" class="relative snap-start w-full h-full flex flex-col gap-3 shrink-0 px-10 justify-center">
        <div class="h-full flex flex-col gap-3 md:gap-10 md:flex-row md:items-center md:justify-between">

          <div class="md:h-full md:grow flex flex-col md:flex-row md:items-center gap-3 md:gap-10 md:overflow-hidden">

            <div class="order-1 md:hidden h-12 shrink-0"></div>

            <div class="order-2 md:w-[33%] flex flex-col gap-3 md:overflow-hidden">

              <div class="text-4xl font-bold">Line routes</div>

              <div class="flex flex-col gap-3 md:overflow-hidden md:overflow-y-scroll md:pb-8">
            ...
            <div class="order-4 md:order-3 md:h-[75dvh] md:grow flex flex-col gap-3 items-center justify-center">
    ...
    <script>
      lucide.createIcons();
      var jsonLine = /^( *)("[\w]+": )?("[^"]*"|[\w.+-]*)?([,[{])?$/mg;
      const jsonReplacer = function(match, pIndent, pKey, pVal, pEnd) {
