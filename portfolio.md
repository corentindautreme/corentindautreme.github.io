...
<html class="overflow-y-scroll scroll-smooth motion-reduce:scroll-auto snap-y snap-mandatory">
  ...
  <body class="bg-black text-white ">
    <!-- top nav -->
    <div class="z-1 fixed top-0 left-0 w-full flex items-center justify-between p-2 backdrop-blur-sm border-b-1 border-white/30">
      <!-- left icon + title -->
            ...
            <div class="flex flex-col mt-1 text-sm md:text-base pb-5">
              ...
              <div class="flex items-center gap-2">
                ...
                <div class="flex gap-2">
                  ...
                  <a class="inline-flex gap-0.5 underline" href="https://lys-web-manager-preview.vercel.app?_vercel_share=gbSZ0UMJMTfpCMi7fhJo7PhvqxsYSr3C">Web manager<i data-lucide="external-link" class="w-4"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="md:grow md:h-full flex items-center gap-15">
            ...
            <div class="md:w-[33%] flex flex-col gap-3">
              ...
              <div class="flex flex-col gap-3">
                ...
                <div class="flex items-center gap-2">
                  <i data-lucide="globe" class="w-4 shrink-0"></i>
                  <div>
                    <a class="inline-flex gap-0.5 underline" href="https://lys-web-manager-preview.vercel.app?_vercel_share=gbSZ0UMJMTfpCMi7fhJo7PhvqxsYSr3C">Lys Web Manager<i data-lucide="external-link" class="w-4"></i></a>
            ...
            <div class="grow flex flex-col gap-3 overflow-y-scroll mask-b-from-90% mask-b-to-100% pb-7">
              ...
              <div class="flex flex-col gap-1">
                ...
                <div class="flex flex-col">
                  ...
                  <div>
                    <a class="inline-flex gap-0.5 underline" href="https://lys-web-manager-preview.vercel.app?_vercel_share=gbSZ0UMJMTfpCMi7fhJo7PhvqxsYSr3C">Lys Web Manager (preview)<i data-lucide="external-link" class="w-4"></i></a>
                    <span class="text-white/50">(demo, access on request)</span>
                  </div>
                </div>
              </div>
            ...
            <div class="hidden md:flex md:grow h-[75dvh] items-center">
              <div class="relative w-full flex items-end justify-between">
                ...
                <svg width="20%" height="auto" viewBox="0 0 140 278" class="z-1">
                  ...
                  <!-- Decorative windows -->
                  <g fill="#704428">
                    <rect x="30" y="73" width="24" height="115" rx="4"/>
                    <rect x="58" y="73" width="25" height="115" rx="4"/>
                    <rect x="87" y="73" width="24" height="115" rx="4"/>
                  </g>
          ...
          <div class="h-full xl:grow flex flex-col xl:flex-row xl:items-center gap-3 xl:gap-10 md:overflow-hidden">
            ...
            <div class="order-2 xl:w-[33%] md:min-h-[150px] min-w-[200px] flex flex-col gap-3 md:overflow-hidden">
              ...
              <div class="flex flex-col gap-3 md:overflow-hidden md:overflow-y-scroll">
                ...
                <p>The output includes a list of lines served at the stop, as well as some extra decoration data (</p>
              </div>
        ...
        [direction: string]: [
          {
            "scheduledAt": string
                  ...
                  <pre class="w-full font-mono json hidden overflow-hidden overflow-scroll text-sm">{"stop":{"id":19,"name":"Skenderija","connections":[{"line":"200E","type":"bus","directions":["Bentbaša"]},{"line":"31E","type":"bus","directions":["Vijećnica"]},{"line":"1","type":"tram","directions":["Baščaršija"]},{"line":"2","type":"tram","directions":["Baščaršija"]},{"line":"3","type":"tram","directions":["Baščaršija"]},{"line":"5","type":"tram","directions":["Baščaršija"]},{"line":"6","type":"tram","directions":["Skenderija","Ilidža"]},{"line":"101","type":"trolleybus","directions":["Trg Austrije","Otoka"]},{"line":"102","type":"trolleybus","directions":["Otoka"]},{"line":"103","type":"trolleybus","directions":["Trg Austrije","Dobrinja"]},{"line":"105","type":"trolleybus","directions":["Trg Austrije"]},{"line":"107","type":"trolleybus","directions":["Dobrinja"]}]},"departures":{"1":{"type":"tram","departures":{"Baščaršija":[{"scheduledAt":"2025-07-23T14:30:00.000Z"},{"scheduledAt":"2025-07-23T14:48:00.000Z"},{"scheduledAt":"2025-07-23T15:06:00.000Z"},{"scheduledAt":"2025-07-23T15:24:00.000Z"},{"scheduledAt":"2025-07-23T15:42:00.000Z"}]}},"2":{"type":"tram","departures":{"Baščaršija":[]}},"3":{"type":"tram","departures":{"Baščaršija":[{"scheduledAt":"2025-07-23T14:27:00.000Z"},{"scheduledAt":"2025-07-23T14:31:00.000Z"},{"scheduledAt":"2025-07-23T14:35:00.000Z"},{"scheduledAt":"2025-07-23T14:39:00.000Z"},{"scheduledAt":"2025-07-23T14:43:00.000Z"}]}},"5":{"type":"tram","departures":{"Baščaršija":[]}},"6":{"type":"tram","departures":{"Ilidža":[{"scheduledAt":"2025-07-23T14:25:00.000Z"},{"scheduledAt":"2025-07-23T14:42:00.000Z"},{"scheduledAt":"2025-07-23T15:00:00.000Z"},{"scheduledAt":"2025-07-23T15:17:00.000Z"},{"scheduledAt":"2025-07-23T15:35:00.000Z"}]}},"101":{"type":"trolleybus","departures":{"Trg Austrije":[],"Otoka":[]}},"102":{"type":"trolleybus","departures":{"Otoka":[{"scheduledAt":"2025-07-23T14:26:00.000Z"},{"scheduledAt":"2025-07-23T14:40:00.000Z"},{"scheduledAt":"2025-07-23T14:58:00.000Z"},{"scheduledAt":"2025-07-23T15:12:00.000Z"},{"scheduledAt":"2025-07-23T15:27:00.000Z"}]}},"103":{"type":"trolleybus","departures":{"Trg Austrije":[{"scheduledAt":"2025-07-23T14:30:00.000Z"},{"scheduledAt":"2025-07-23T14:41:00.000Z"},{"scheduledAt":"2025-07-23T14:52:00.000Z"},{"scheduledAt":"2025-07-23T15:03:00.000Z"},{"scheduledAt":"2025-07-23T15:14:00.000Z"}],"Dobrinja":[{"scheduledAt":"2025-07-23T14:33:00.000Z"},{"scheduledAt":"2025-07-23T14:44:00.000Z"},{"scheduledAt":"2025-07-23T14:55:00.000Z"},{"scheduledAt":"2025-07-23T15:06:00.000Z"},{"scheduledAt":"2025-07-23T15:17:00.000Z"}]}},"105":{"type":"trolleybus","departures":{"Trg Austrije":[{"scheduledAt":"2025-07-23T14:33:00.000Z"},{"scheduledAt":"2025-07-23T14:46:00.000Z"},{"scheduledAt":"2025-07-23T14:59:00.000Z"},{"scheduledAt":"2025-07-23T15:11:00.000Z"},{"scheduledAt":"2025-07-23T15:24:00.000Z"}]}},"107":{"type":"trolleybus","departures":{"Dobrinja":[{"scheduledAt":"2025-07-23T14:29:00.000Z"},{"scheduledAt":"2025-07-23T14:55:00.000Z"},{"scheduledAt":"2025-07-23T15:09:00.000Z"},{"scheduledAt":"2025-07-23T15:29:00.000Z"},{"scheduledAt":"2025-07-23T15:50:00.000Z"}]}},"31E":{"type":"bus","departures":{"Vijećnica":[]}},"200E":{"type":"bus","departures":{"Bentbaša":[{"scheduledAt":"2025-07-23T14:37:00.000Z"},{"scheduledAt":"2025-07-23T15:12:00.000Z"},{"scheduledAt":"2025-07-23T15:57:00.000Z"},{"scheduledAt":"2025-07-23T16:37:00.000Z"},{"scheduledAt":"2025-07-23T17:42:00.000Z"}]}}}}</pre>
                </div>
                
                <div class="relative flex flex-col flex-1/2 md:overflow-hidden">
                  <div class="py-1">a</div>
                  <div class="grow md:rounded-lg md:overflow-hidden md:overflow-y-scroll">
                    <img src="https://raw.githubusercontent.com/corentindautreme/corentindautreme.github.io/refs/heads/portfolio/images/portfolio/transit_planner_client_line.png" class="mx-auto rounded-lg md:rounded-none" width="full" height="auto"/>
                  </div>
                </div>
              </div>
